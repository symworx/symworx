...
- Linear mixed models (LMM) to symworx-stats
  (this is a rust-only feature right now and python bindings will be added later)

### Changed

- Updated copyright to list PalEm Dynamics 
